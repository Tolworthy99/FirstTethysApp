...
@app_workspace
@login_required()
def form_page(request, app_workspace):
    """
    ...
    if request.POST and 'add-button' in request.POST:
        ...
        if not has_errors:
            # Do stuff here
            add_new_dam(db_directory=app_workspace.path, location=location, name=name, owner=owner, river=river,
    ...
    return render(request, 'dam_inventory/form_page.html',context)
